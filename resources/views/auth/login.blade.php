...
@section('content')
    <div class="text-center mb-6">
        ...
        <p class="text-gray-500 mt-1 text-sm">Sign in to continue your learning journey</p>
    </div>
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required
                       class="w-full border {{ $errors->has('email') ? 'border-red-400' : 'border-gray-300' }} rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 transition-colors">
            ...
            <div x-data="{ show: false }">
                <div class="flex justify-between items-center mb-1">
                    ...
                    <a href="{{ route('auth.forgot') }}" class="text-xs text-brand-600 hover:underline">Forgot password?</a>
                </div>
                <div class="relative">
                    <input :type="show ? 'text' : 'password'" name="password" required
                           class="w-full border border-gray-300 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500">
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" id="remember" name="remember" class="w-4 h-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500">
...
@section('footer_link')
    Don't have an account? <a href="{{ route('auth.register') }}" class="text-white font-semibold hover:underline">Create one free</a>
@endsection
