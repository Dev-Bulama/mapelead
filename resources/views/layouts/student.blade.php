...
<head>
    ...
    <title>@yield('title', 'Dashboard') — {{ \App\Models\SiteSetting::get('site_name', 'MapeLeads') }}</title>
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="px-6 py-5 border-b border-gray-100">
            <a href="{{ route('home') }}" class="flex items-center gap-2">
                ...
                <span class="font-bold text-gray-900">{{ \App\Models\SiteSetting::get('site_name', 'MapeLeads') }}</span>
            </a>
        </div>
